...
// geojsonhint library is no longer active and has a security vulnerability
...
var toStringFirst = function (x, func) {
  return func(x !== null && x !== undefined ? x.toString() : x);
};
...
module.exports = {
  ...
  'numeric': function (x) {
    return toStringFirst(x, validator.isNumeric);
  },
  ...
  'int': function (x) {
    return toStringFirst(x, validator.isInt);
  },
  'integer' : function (x) {
    return toStringFirst(x, validator.isInt);
  },
  ...
  'decimal' : function (x) {
    return toStringFirst(x, validator.isFloat);
  },
  'float'   : function (x) {
    return toStringFirst(x, validator.isFloat);
  },
  ...
  'null'    : _.isNull,
  'notNull' : function (x) { return !validator.isEmpty(x); },
  ...
  // Miscellaneous rules
  'after'   : function (x) {
    return toStringFirst(x, validator.isAfter);
  },
  'before'  : function (x) {
    return toStringFirst(x, validator.isBefore);
  },
